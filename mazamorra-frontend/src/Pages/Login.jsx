        ...
        <section className="relative flex flex-wrap h-screen lg:items-center bg-primary">
            <div className=" w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
                <div className="mx-auto max-w-lg text-center">
                    <h1 className="text-2xl font-bold sm:text-5xl text-second_color">Iniciar sesión</h1>

                    <p 
                    onClick={() => navigate('/register')}
                    className="mt-4 text-second_color font-semibold cursor-pointer">
                        <span className='text-gray-400 font-light'>Aun no tienes una cuenta?</span> Registar
                    </p>
                </div>
